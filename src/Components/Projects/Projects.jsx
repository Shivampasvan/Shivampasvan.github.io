      ...
      <div className="section">
          ...
          <div className="project">
            ...
            <div className="project_information" data-aos="fade-right">
              ...
              <p>
                ...
                services. The company, which caters to individual sellers and
        ...
        <div className="projects_container">
          <div className="project">
            ...
            <div className="project_information" data-aos="fade-right">
              ...
              <div>
                <a
                  href="https://project-lyart-zeta.vercel.app/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <span type="button" className="btn btn--outline onbt">
        ...
        <div className="projects_container">
          <div className="project">
            <div className="project_videocontainer">
              <div data-aos="fade-right">
                <img src={geek} alt="GeekBuying Clone" />
              </div>
            </div>
            <div className="project_information" data-aos="fade-right">
              ...
              <p>
                ...
                comfortable and smarter. If you are looking for the latest and
          ...
          <div className="project">
            ...
            <div className="project_information" data-aos="fade-right">
              ...
              <p>
                ...
                focusing on broadcast and digital news publication. The company
                is considered to be a legacy brand that pioneered independent
                news broadcasting in India.
              </p>
              <div>
                <SiJavascript />
                <SiHtml5 />
